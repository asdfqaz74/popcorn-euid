import"./tailwind-75xaDfuL.js";import{g as c}from"./index-35H_NU9g.js";import{g as i,a as f,C as v}from"./delay-g6vF19wW.js";import{i as d}from"./insert-vWB_d1l7.js";import{g as y}from"./getPbImageURL-99Z79ldm.js";import{t as p}from"./timeAgo-WbyvHha8.js";import{f as g}from"./formattedDate-dxVwGQ40.js";const n=i(".togetherBoard-write-off"),m=i(".togetherBoard-write-on"),r=i(".togetherBoard-plus-menu"),x=i(".write-button"),b=f(".togetherBoard"),u=new v("https://popcorns.pockethost.io");async function h(s){const a=(await u.collection("community").getList(1,50,{expand:"SR_location"})).items;if(s){w(s);return}a.forEach(t=>{const o=t.recruiting===""?"모집중":t.recruiting,l=`
