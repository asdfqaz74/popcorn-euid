import"./tailwind-zBIZP7u3.js";import{r as c,a as r}from"./css-LUmow4Y_.js";import{C as S,g as i,a as v}from"./delay-g6vF19wW.js";import{i as $}from"./insert-yGrdL5nD.js";import{g as I}from"./getPbImageURL-99Z79ldm.js";import{f as A,a as D}from"./formattedDate-dxVwGQ40.js";import{g}from"./index-35H_NU9g.js";const C=new S("https://popcorns.pockethost.io");i(".boardContentsContainer");i(".boardContent-more");const R=i(".boardContent-back"),U=i(".boardContent-back-edit"),k=document.getElementById("menu-button");i(".updateMenu");const M=v(".update-button");i("board-container-info");const _=i(".completeUpdateButton"),T=v(".boardContent-category"),q=v(".boardContent-state"),m=window.location.hash.slice(1),a=await C.collection("community").getOne(m,{expand:"SR_location"});async function P(){const{SR_location:t,activity:e,category:n,date:o,meetingLocation:s,gender:d,approve:b,headcount:l,age:f,title:u,time:L,expand:E,id:y,recruiting:h="모집중"}=a,w=h===""?"모집중":h;console.log(a);const B=`
        ...
        <div class="boardContent-wrapper  pb-[40%] pt-6 px-3 mb-[4.625rem]">
          ...
          <div  class="flex flex-col text-lg font-semibold mt-[0.5625rem]">
            ...
            <span class="boardContent-title">${u}</span>
          </div>
