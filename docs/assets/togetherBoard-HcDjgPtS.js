import"./tailwind-NE021wVL.js";import{g as c}from"./index-35H_NU9g.js";import{g as a,a as x,C as b}from"./delay-g6vF19wW.js";import{i as d}from"./insert-vWB_d1l7.js";import{g as p}from"./getPbImageURL-99Z79ldm.js";import{t as g}from"./timeAgo-WbyvHha8.js";import{f as u}from"./formattedDate-dxVwGQ40.js";import{f as h,c as m}from"./calender-6jrPqTjm.js";const r=a(".togetherBoard-write-off"),f=a(".togetherBoard-write-on"),i=a(".togetherBoard-plus-menu"),k=a(".write-button"),w=x(".togetherBoard"),v=new b("https://popcorns.pockethost.io"),$=new a(".backButton");async function y(o){if(o){B(o);return}const s=(await v.collection("community").getList(1,50,{expand:"SR_location",sort:"-created"})).items;console.log(s),s.forEach(e=>{const n=e.recruiting===""?"모집중":e.recruiting,l=`
