import"./tailwind-zZkDsczm.js";import{g as r}from"./delay-g6vF19wW.js";import{i as k}from"./insert-yGrdL5nD.js";import{c as y,h as B}from"./heart-WHLtlnmW.js";import{g as f}from"./storage-eNv634Ip.js";import{g as u}from"./getPbImageURL-99Z79ldm.js";import{s as L}from"./setDocumentTitle-_OwlDZqT.js";import{t as $}from"./timeAgo-WbyvHha8.js";import{r as v}from"./removeChild-y_437bHv.js";import{g}from"./index-35H_NU9g.js";import{p as c}from"./pocketbase-UOLpUAtS.js";const C="data:image/svg+xml,%3csvg%20width='16'%20height='17'%20xmlns='http://www.w3.org/2000/svg'%20fill='none'%3e%3cg%3e%3ctitle%3eLayer%201%3c/title%3e%3cline%20stroke-linecap='undefined'%20stroke-linejoin='undefined'%20id='svg_4'%20y2='301'%20x2='721'%20y1='301'%20x1='721'%20opacity='NaN'%20stroke='red'%20fill='none'/%3e%3cline%20stroke-linecap='undefined'%20stroke-linejoin='undefined'%20id='svg_5'%20y2='282'%20x2='718'%20y1='282'%20x1='718'%20opacity='NaN'%20stroke='red'%20fill='none'/%3e%3cline%20stroke-linecap='undefined'%20stroke-linejoin='undefined'%20id='svg_6'%20y2='466'%20x2='926'%20y1='466'%20x1='926'%20opacity='NaN'%20stroke='red'%20fill='none'/%3e%3crect%20id='svg_35'%20height='0.84699'%20width='10.98361'%20y='4.6694'%20x='2.56284'%20stroke='red'%20fill='none'/%3e%3crect%20id='svg_36'%20height='0.95628'%20width='10.79235'%20y='6.11749'%20x='2.64481'%20stroke='red'%20fill='none'/%3e%3crect%20id='svg_37'%20height='0.87432'%20width='9.23497'%20y='7.64754'%20x='3.2459'%20stroke='red'%20fill='none'/%3e%3crect%20id='svg_38'%20height='0.71038'%20width='7.65027'%20y='9.06831'%20x='4.14754'%20stroke='red'%20fill='none'/%3e%3crect%20id='svg_39'%20height='0.38251'%20width='4.94536'%20y='10.24317'%20x='5.51366'%20stroke='red'%20fill='none'/%3e%3crect%20id='svg_40'%20height='0.30055'%20width='3.06011'%20y='11.14481'%20x='6.33333'%20stroke='red'%20fill='none'/%3e%3crect%20id='svg_41'%20height='0.32787'%20width='1.42077'%20y='12.01913'%20x='7.15301'%20stroke='red'%20fill='none'/%3e%3crect%20id='svg_42'%20height='0.4918'%20width='2.97814'%20y='3.98634'%20x='3.38251'%20stroke='red'%20fill='none'/%3e%3crect%20id='svg_43'%20height='0.60109'%20width='2.97814'%20y='4.06831'%20x='9.50273'%20stroke='red'%20fill='none'/%3e%3cpath%20id='svg_1'%20fill='black'%20d='m8.06659,12.6296l-0.06667,0.0667l-0.07333,-0.0667c-3.16667,-2.87333%20-5.26,-4.77333%20-5.26,-6.69999c0,-1.33334%201,-2.33334%202.33333,-2.33334c1.02666,0%202.02666,0.66667%202.38,1.57334l1.24,0c0.35333,-0.90667%201.35333,-1.57334%202.37998,-1.57334c1.3334,0%202.3334,1%202.3334,2.33334c0,1.92666%20-2.0934,3.82666%20-5.26671,6.69999zm2.93331,-10.36666c-1.15998,0%20-2.27332,0.54%20-2.99998,1.38667c-0.72667,-0.84667%20-1.84,-1.38667%20-3,-1.38667c-2.05333,0%20-3.66667,1.60667%20-3.66667,3.66667c0,2.51333%202.26667,4.57329%205.7,7.68669l0.96667,0.88l0.96666,-0.88c3.43332,-3.1134%205.70002,-5.17336%205.70002,-7.68669c0,-2.06%20-1.6133,-3.66667%20-3.6667,-3.66667z'/%3e%3c/g%3e%3c/svg%3e";L("EUID / 상품정보");const I=r(".exchangeBoard-back");I.addEventListener("click",()=>history.back());const P=r(".exchangeBoard-more");function _(){r(".exchangeBoard-sidebar ul").classList.toggle("translate-x-full")}P.addEventListener("click",_);async function S(){const e=window.location.hash.slice(1),t=await c.collection("products").getOne(e),s=r(".delete"),a=r(".update"),i=r(".declaration"),o=await f("userId");t.userPost===o?(s.classList.remove("hidden"),a.classList.remove("hidden"),i.classList.add("hidden")):(s.classList.add("hidden"),a.classList.add("hidden"),i.classList.remove("hidden"));async function l(){if(confirm("정말 삭제하시겠습니까?")==!0)await c.collection("products").delete(e),window.location.href="/src/pages/exchange/";else return!1}s.addEventListener("click",l),a.addEventListener("click",()=>window.location.href=`/src/pages/exchangeEdit/index.html#${t.id}`)}async function b(){const e=window.location.hash.slice(1);v(".exchangeBoard-img"),v(".exchangeBoard-another");const t=await c.collection("products").getOne(e,{expand:"userPost"}),s=await c.collection("products").getList(1,4,{sort:"@random"}),a=await c.collection("users").getFirstListItem(`id="${t.userPost}"`);E(t,a),j(s)}async function E(e,t){const s=`
  ...
  >
    ...
    `;k(".exchangeBoard-another",s)})}const m=B,p=C;let n;async function N(e){n=e.target;const t=n.src,s=await f("userId"),a=await c.collection("likes").getFullList(),i=window.location.hash.slice(1),l=(await c.collection("products").getOne(i)).id,d=a.find(w=>w.product===l&&w.user===s);let h;d&&(h=d.id);const x={user:s,product:l};d?t.includes(m)?(await c.collection("likes").create(x),g.from(n,{scale:.6,duration:.2,onComplete:()=>{n.src=p,g.to(n,{scale:1,duration:.1})}})):(await c.collection("likes").delete(h),g.from(n,{scale:1.5,duration:.1,onComplete:()=>{n.src=m,g.to(n,{scale:1,duration:.2})}})):t.includes(m)&&(await c.collection("likes").create(x),g.from(n,{scale:.6,duration:.2,onComplete:()=>{n.src=p,g.to(n,{scale:1,duration:.1})}}))}async function F(e,t){n=r(".exchangeBoard-heart img");const s=await c.collection("likes").getFullList(),a=t.id;s.find(o=>o.product===a&&o.user===e)?n.src=p:n.src=m}async function O(e,t){const a=(await c.collection("chatbox").getFullList()).filter(h=>h.buyer===e),i=t.id,o=a.find(h=>h.item===i),l={buyer:`${e}`,item:`${i}`};let d;return!a||!o?d=(await c.collection("chatBox").create(l)).id:d=o.id,d}async function H(){await S(),b().then(async()=>{const e=r(".exchangeBoard-chat-link"),t=await f("userId"),s=window.location.hash.slice(1),a=await c.collection("products").getOne(s);F(t,a),r(".exchangeBoard-heart").addEventListener("click",N),e.addEventListener("click",async o=>{o.preventDefault();const l=await O(t,a);e.href=`/src/pages/chat/index.html#${l}`,window.location.href=e.href}),window.addEventListener("hashchange",b)})}H();
