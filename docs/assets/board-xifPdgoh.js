import"./tailwind-75xaDfuL.js";import{g as s,C as d}from"./delay-g6vF19wW.js";import{i as n}from"./insert-vWB_d1l7.js";import{g as p}from"./getPbImageURL-99Z79ldm.js";import{t as u}from"./timeAgo-WbyvHha8.js";import{f as g}from"./formattedDate-dxVwGQ40.js";import{g as a}from"./index-35H_NU9g.js";const r=s(".subjectMenu"),o=s(".subject-menu-container"),c=s(".board-closedSubjectMenu-button"),b=new d("https://popcorns.pockethost.io");async function m(){(await b.collection("community").getList(1,50,{expand:"SR_location"})).items.forEach(e=>{console.log(e);const l=`
    <div
