import"./tailwind-75xaDfuL.js";import{r as d,a as l}from"./css-LUmow4Y_.js";import{C as B,g as c,a as v}from"./delay-g6vF19wW.js";import{i as $}from"./insert-vWB_d1l7.js";import{g as I}from"./getPbImageURL-99Z79ldm.js";import{f as A,a as D}from"./formattedDate-dxVwGQ40.js";import{g as m}from"./index-35H_NU9g.js";const p=new B("https://popcorns.pockethost.io");c(".boardContentsContainer");c(".boardContent-more");const R=c(".boardContent-back"),U=c(".boardContent-back-edit"),x=document.getElementById("menu-button");c(".updateMenu");const M=v(".update-button");c("board-container-info");const _=c(".completeUpdateButton"),q=v(".boardContent-category"),P=v(".boardContent-state"),k=window.location.hash.slice(1),a=await p.collection("community").getOne(k,{expand:"SR_location"});async function T(){const{SR_location:t,activity:e,category:o,date:s,meetingLocation:n,gender:i,approve:r,headcount:u,age:f,title:g,time:y,expand:w,id:C,recruiting:h="모집중"}=a,E=h===""?"모집중":h;console.log(a);const S=`
