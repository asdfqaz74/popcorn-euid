import"./tailwind-zZkDsczm.js";import{a as g}from"./css-LUmow4Y_.js";import{g as o,a as u}from"./delay-g6vF19wW.js";import{i as s}from"./insert-yGrdL5nD.js";import{g as y,d as m,s as L}from"./storage-eNv634Ip.js";import{a as h,r as f}from"./rendering-oARfkKZz.js";import{g as b}from"./getPbImageURL-99Z79ldm.js";import{t as k}from"./timeAgo-WbyvHha8.js";import{p as a}from"./pocketbase-UOLpUAtS.js";const P=o(".profile-button-close"),$=u(".profile-listBox-button"),v=o(".profile-button-more"),C=o(".profile-temperatureBar-container"),E=o(".profile-button-logOut");let l=0,n=0;function B(){history.back()}P.addEventListener("click",B);function S(){const t=this.nextElementSibling,e=this.querySelector("button");t.classList.toggle("hidden"),e.classList.toggle("rotate-90")}$.forEach(t=>{t.addEventListener("click",S)});const A=await a.collection("users").getFullList(),p=await y("userId");let i=A.find(t=>t.id===p);h(".rendering-photo",i);f(".rendering-box",i);function N(){Array.from(u(".profile-textPrivacy")).forEach(e=>{let r=`${e.textContent.slice(0,4)}***`;e.textContent=r})}N();const F=await a.collection("likes").getFullList({expand:"product"}),w=await a.collection("products").getFullList({expand:"user"});async function M(){F.forEach(d=>{d.expand&&p===d.expand.product.userPost&&l++});let t=36.5+l*.5;const e=`
  <div class="flex">
            <span
