import"./tailwind-zZkDsczm.js";import{a as r,r as l}from"./css-LUmow4Y_.js";import{C as E,g as i,a as f}from"./delay-g6vF19wW.js";import{i as B}from"./insert-yGrdL5nD.js";import{g as $}from"./storage-eNv634Ip.js";import{g as I}from"./getPbImageURL-99Z79ldm.js";import{f as R,a as A}from"./formattedDate-dxVwGQ40.js";import{g as m}from"./index-35H_NU9g.js";const g=new E("https://popcorns.pockethost.io");i(".boardContentsContainer");i(".boardContent-more");const D=i(".boardContent-back"),M=i(".boardContent-back-edit"),x=document.getElementById("menu-button");i(".updateMenu");const _=f(".update-button");i("board-container-info");const U=i(".completeUpdateButton"),P=f(".boardContent-category"),q=f(".boardContent-state"),k=window.location.hash.slice(1),a=await g.collection("community").getOne(k,{expand:"SR_location"});async function V(){const t=await $("userId"),{SR_location:e,activity:o,category:s,date:n,meetingLocation:c,gender:d,approve:y,headcount:b,age:v,title:u,time:O,expand:w,id:C,recruiting:h="모집중"}=a;a.expand.SR_location.id!=t&&(T(),console.log(a.expand.SR_location.id,t)),console.log(a);const S=`
